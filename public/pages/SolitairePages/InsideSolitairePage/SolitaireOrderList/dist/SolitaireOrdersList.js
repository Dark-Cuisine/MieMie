...
var SolitaireOrderList = function (props) {
    ...
    return (react_1["default"].createElement(components_1.View, { className: 'solitaire_orders_list'.concat(props.className) }, state.solitaireOrders.map(function (it) {
        react_1["default"].createElement(components_1.View, { className: '' }, "a or");
    })));
};
