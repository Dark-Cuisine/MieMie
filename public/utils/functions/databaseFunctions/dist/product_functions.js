...
exports.updateProductStock =
  ...
  exports.addProductIdToSolitaire =
  exports.addProductIdToShop =
  exports.addNewProducts =
    void 0;
var dayjs_1 = require("dayjs");
exports.addNewProducts = function (
  way,
  newProductList,
  shopId,
  shopName,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          updatedProduct = __assign(__assign({}, porduct), {
            authId: authId,
            shopId: shopId,
            shopName: shopName,
...
exports.modifyProduct = function (product) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          updatedProduct = __assign(__assign(__assign({}, product), newStock), {
            updatedStock: {
              way: "",
              quantity: 0,
            },
...
exports.deleteProducts = function (deletedProducts) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      ...
      for (
        _i = 0, deletedProducts_1 = deletedProducts;
        _i < deletedProducts_1.length;
        _i++
      ) {
