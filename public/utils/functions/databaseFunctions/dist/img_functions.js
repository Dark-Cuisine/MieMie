...
//压缩和上传图片到云储存
exports.compressAndUploadImg = function (img, fileDir, prefix) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, wx.compressImage({
                        src: img.url,
                        quality: 20
                    })];
            case 2:
...
//从云储存删除图片
exports.deleteImgs = function (deletedUrl) { return __awaiter(void 0, void 0, void 0, function () {
    var c1, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
